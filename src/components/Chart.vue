<template>
  <div class="box overflow-hidden  m-auto relative block">
    ...
    <div v-motion-small-graph2 class="boxie three"></div>
    <div v-motion-small-graph3 class="boxie four"></div>
    <div v-motion-large-graph3 class="boxie five pos"></div>
    <div  v-motion-large-graph4 class="boxie six pos"></div>
    <div
      v-motion-large-graph4
      class="boxie seven pos"
    ></div>
    <div  v-motion-large-graph5  class="boxie eight pos"></div>
    <div v-motion-large-graph5 class="boxie nine pos"></div>
    <div v-motion-max-graph class="boxie ten pos"></div>
    <div v-motion-max-graph class="boxie elev pos"></div>
    <div v-motion-max-graph class="boxie twel pos"></div>
    <div v-motion-max-graph class="boxie fou pos"></div>
  ...
  <div class="box2 flex relative m-auto">
    ...
    <img src="./../assets/syncfusion.png" alt="" />
